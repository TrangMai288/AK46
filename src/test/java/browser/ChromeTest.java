...
//        chromeOptions.addArguments("--headless=new");
    ...
    @Test
    void openBrowserWithBetaVesion() {
        ChromeOptions chromeOptions = new ChromeOptions();
    ...
    void openBrowserWithFakeGeoLocation() {
        ...
        //driver.findElement(By.xpath("//bur"))
        driver.quit();
    }
    ...
    void simulate3GNetworkCondition() {
        ...
        devTools.send(org.openqa.selenium.devtools.v129.network.Network.enable(
                Optional.of(100000000),
                Optional.empty(),
                Optional.empty()));

        // Set network conditions to emulate 3G or 4G
        devTools.send(org.openqa.selenium.devtools.v129.network.Network.emulateNetworkConditions(
                false,
                100,
                75000,
                25000,
